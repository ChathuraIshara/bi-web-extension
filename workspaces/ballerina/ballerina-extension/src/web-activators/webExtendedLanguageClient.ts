...
import { LanguageClient, LanguageClientOptions,DefinitionParams, InitializeParams, InitializeResult, Location, LocationLink, TextDocumentPositionParams } from "vscode-languageclient/browser";
...
export class WebExtendedLanguageClient extends LanguageClient implements ExtendedLangClientInterface {
    ...
    didOpen(params: DidOpenParams): void {
        ...
        console.log("opened a file,didOpen params: ", params);
