...
import { fetchAndCacheLibraryData } from './web-activators/library-browser/activator';
...
const stateMachine = createMachine<MachineContext>(
    ...
    services: {
        ...
        openWebView: (context, event) => {
            console.log("reached to openwebview state");
            console.log('extension uri',ballerinaExtInstance.context.extensionUri);
            console.log('extension uri fs path',ballerinaExtInstance.context.extensionUri.fsPath);
